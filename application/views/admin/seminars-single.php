<?php include('header.php'); ?>
    ...
    <section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(img/page-banner-3.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="seminars.php">Seminars</a></li>
                ...
                <div class="row">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="event-date">
                                            <span>Date</span>
                                            <h6>2 December 2018</h6>
                                        </div>
                                    </li>
                                </ul>
                            </div> <!-- course terms -->
                            
                            <img src="img/se-1.jpg" alt="Event">
                    ...
                    <div class="col-lg-4">
                        <div class="event-interest">
                            <div class="ei-quest">
                                <p>Are you going?</p>
                                <p class="ei-ans"><span>5</span> people going</p>
                            </div>
                            <div class="ei-accept">
                                <a href="#" data-toggle="modal" data-target="#modal1" class="eia-yes"><i class="fa fa-check"></i></a>
                                <a href="#" data-toggle="modal" data-target="#modal1" class="eia-no"><i class="fa fa-close"></i></a>
                            </div>
                        </div>
                        
                        <div class="events-right">
                            <div class="events-coundwon bg_cover" data-overlay="8" style="background-image: url(img/coundown.jpg)">
                                <div data-countdown="2019/03/01"></div>
                                <div class="events-coundwon-btn pt-30">
                                    <a href="seminar-register.php" class="main-btn">Book Your Seat</a>
                                </div>
                            </div> <!-- events coundwon -->
                            <div class="events-address mt-30">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15221.050281280799!2d78.388458!3d17.494975!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe33ae6c3ea74c04e!2sPrachaTech+Software+Solutions!5e0!3m2!1sen!2sin!4v1549259275474" width="100%" height="auto" frameborder="0" class="mt-25" style="border:0; border-radius: 5px;" allowfullscreen></iframe><!-- Map -->
                            </div> <!-- events address -->
