    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider bg_cover pt-150" style="background-image: url(<?php echo base_url();?>assets/vendor/img/s-1.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
							...
							<p data-animation="fadeInUp" data-delay="1.3s">We offer Coaching & Training for Engineering & Medical students
							</br>
        ...
        <div class="single-slider bg_cover pt-150" style="background-image: url(<?php echo base_url();?>assets/vendor/img/s-2.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-9">
                        <div class="slider-cont">
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-1">
                                        <span class="icon">
                                            <img src="img/ctg-1.png" alt="Icon">
                                        </span>
                                        <span class="cont">
                                            <span>Language</span>
                                        </span>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-2">
                                        <span class="icon">
                                            <img src="img/ctg-2.png" alt="Icon">
                                        </span>
                                        <span class="cont">
                                            <span>Business</span>
                                        </span>
                            ...
                            <div class="col-lg-4">
                                <a href="#">
                                    <span class="singel-category text-center color-3">
                                        <span class="icon">
                                            <img src="img/ctg-3.png" alt="Icon">
                                        </span>
                                        <span class="cont">
    ...
    <section id="about-part" class="pt-65">
        ...
        <div class="about-bg">
            <img src="<?php echo base_url();?>assets/vendor/img/bg-1.png" alt="About">
        </div>
    </section>
    
    
     <section id="why-section" class=" pt-60 pb-60" style="background-image: url(<?php echo base_url();?>assets/vendor/img/why-bac.png)">
		<div class="container">
		<div class="row">
            ...
            <div class="row course-slied mt-30">
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        <div class="thum">
                            <div class="image">
                                <img src="img/cu-4.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course">
                        <div class="thum">
                            <div class="image">
                                <img src="img/cu-5.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row testimonial-slied mt-40">
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="img/tst-1.jpg" alt="Testimonial">
                            <div class="quote">
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="img/tst-2.jpg" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="singel-testimonial">
                        <div class="testimonial-thum">
                            <img src="img/tst-3.jpg" alt="Testimonial">
                            <div class="quote">
                                <i class="fa fa-quote-right"></i>
                            </div>
                        </div>
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center">
                        <img src="img/part-1.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center">
                        <img src="img/part-2.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center">
                ...
                <div class="col-lg-12">
                    <div class="singel-patnar text-center">
                        <img src="img/part-4.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center">
