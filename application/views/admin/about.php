<?php include('header.php'); ?>
    ...
    <div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8" style="background-image: url(img/bg-2.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-counter text-center mt-40">
                        <span><span class="counter">5,000</span>+</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-counter text-center mt-40">
                        <span><span class="counter">4,000</span>+</span>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="img/t-5.jpg" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="img/t-6.jpg" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="img/t-7.jpg" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="singel-teachers mt-30 text-center">
                        <div class="image">
                            <img src="img/t-8.jpg" alt="Teachers">
                        </div>
                        <div class="cont">
                            <a><h6>Mark alen</h6></a>
                            <span>Vice chencelor</span>
    ...
    <section id="testimonial" class="bg_cover pt-115 pb-120" data-overlay="8" style="background-image: url(img/bg-2.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
    ...
    <div id="patnar-logo" class="pt-10 pb-10 gray-bg">
        <div class="container">
