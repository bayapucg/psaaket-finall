...

{
	...
	public function login_details($e_email_work,$e_password){
		$sql = "SELECT e_id,role,e_email_work FROM employees WHERE (e_email_work ='".$e_email_work."' AND e_password='".$e_password."'  AND status='1') OR (e_email_work ='".$e_email_work."' AND e_password='".$e_password."' AND status='1')";
